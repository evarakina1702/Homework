...
class CompanyID:
    __scripts = {
        ...
        "select_only_active": 'select * from company ' 'where deleted_at is null ' 'and is_active = true',
    ...
    @allure.step('Удалить компанию из базы данных по идентификатору')
    ...
    @allure.step('Создать компанию в базе данных')
    ...
    @allure.step('Получите максимальный идентификатор компании от базы данных')
