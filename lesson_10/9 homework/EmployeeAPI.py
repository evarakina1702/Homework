...
class EmployeeApi:
    ...
    def add_employee(self, id: int, first_name: str, last_name: str, middle_name: str, company_id: int, email: str, employee_url: str, phone: str, birthdate: str, is_active: bool) -> dict:
        ...
        resp = requests.post(f'{self.url}/employee', json=body, headers=my_headers)
        return resp.json()
    ...
    def change_employee(self, employee_id: int, new_email: str, new_url: str, new_is_active: bool) -> dict:
        ...
        resp = requests.patch(f'{self.url}/employee/{employee_id}', json=body, headers=my_headers)
        return resp.json()